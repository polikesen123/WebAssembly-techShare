(module
 ...
 (export "getPrime" (func $assembly/index/getPrime))
 (export "getFib" (func $assembly/index/getFib))
 ...
 (func $assembly/index/getPrime (param $0 i32) (result f64)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 0
 ...
 (func $assembly/index/getFib (param $0 i32) (result f64)
  local.get $0
  i32.const 2
  i32.lt_u
  if
